...
class AboutClassMethods < Neo::Koan
  ...
  # ------------------------------------------------------------------
  # class Dog
  LAST_EXPRESSION_IN_CLASS_STATEMENT = class Dog # rubocop:disable Style/Documentation
                                         21
                                       end
  ...
  # class Dog
  class Dog
    def self.another_way
      :another_way_to_write_class_methods
    end
  end

  def test_you_can_use_self_instead_of_an_explicit_reference_to_dog
    assert_equal :another_way_to_write_class_methods, Dog.another_way
  end
